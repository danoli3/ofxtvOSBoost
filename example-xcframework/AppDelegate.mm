    ...
    didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    textView.font = [UIFont fontWithName:@"Menlo" size:20.0];
    ...
    self.ciMode = std::getenv("OFXTVOSBOOST_CI") != nullptr;
    self.textView = textView;
    textView.text = self.testReport;
    [controller.view addSubview:textView];
    [NSLayoutConstraint activateConstraints:@[
        [textView.leadingAnchor constraintEqualToAnchor:controller.view.leadingAnchor constant:16.0],
        [textView.trailingAnchor constraintEqualToAnchor:controller.view.trailingAnchor constant:-16.0],
        [textView.topAnchor constraintEqualToAnchor:controller.view.topAnchor constant:16.0],
        [textView.bottomAnchor constraintEqualToAnchor:controller.view.bottomAnchor constant:-16.0]
    ]];
